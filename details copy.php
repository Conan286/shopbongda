                    ...
                    <form method="post" action="details.php?product_id=<?= $product_id; ?>">
                        ...
                        <div class="select-star-rating">
                            ...
                            <span class="star-rating">
                                ...
                                for ($i = 1; $i <= 5; $i++) {
                                    echo '<svg class="star-rating__star-icon" width="12" height="12" fill="#ccc"
            viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"
            onclick="setRating(' . $i . ')">
            <path d="M11.1429 5.04687 ..."></path>
          </svg>';
                                }
                                ?>
                        ...
                        <div class="mb-4">
                            <textarea id="form-input-review" class="form-control form-control_gray"
                                placeholder="Your Review" name="review_text" cols="30" rows="8"></textarea>
                        </div>
                        <div class="form-check mb-4">
                            <input class="form-check-input form-check-input_fill" type="checkbox" value=""
                                id="remember_checkbox" name="remember_checkbox">
